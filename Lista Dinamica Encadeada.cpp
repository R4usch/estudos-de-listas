...
public:
    ...
    void Remover(string texto) {
        ...
        Item* anteriorItem = PrimeiroItem;
        Item* currentItem = PrimeiroItem->Proximo;
        Item* proximoItem = nullptr;
        bool encontrou = false;
        while (true) {
            if (currentItem->valor == texto) {
                proximoItem = currentItem->Proximo;
                encontrou = true;
                break;
            }
            else {
        ...
        cout << "Anterior item " << anteriorItem->valor << " agora aponta para proximo item " << proximoItem->valor << endl;
        anteriorItem->Proximo = proximoItem;
